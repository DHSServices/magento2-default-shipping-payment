    ...
    return function (checkoutDataResolver) {
        ...
        return _.extend(checkoutDataResolver, {
            ...
            getMethodBySelectionType: function (methodType, selectionType) {
                if (!_.isUndefined(config.dhsservicesDefaultShippingPayment)
                    && !_.isUndefined(config.dhsservicesDefaultShippingPayment[methodType])
                ) {
                    return config.dhsservicesDefaultShippingPayment[methodType][selectionType];
                }
            },
